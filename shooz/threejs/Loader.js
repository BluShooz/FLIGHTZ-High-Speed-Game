...
/*!
 * @package shooz.threejs
 */
var shooz = shooz || {};
shooz.threejs = shooz.threejs || {};

shooz.NONE = undefined;

/**
 * Creates a new loader
 * @param {Object{onLoad, onError, onProgress}} opts Callbacks
 */
shooz.threejs.Loader = function(opts)
{
	var self = this;
 ...
 */
shooz.threejs.Loader.prototype.load = function(data)
{
	var self = this;
...
shooz.threejs.Loader.prototype.updateState = function(type, name, state)
{
 ...
 * @return Mixed
 */
shooz.threejs.Loader.prototype.get = function(type, name)
{
	if(!(type in this.types))
	{
		console.warn("Unkown loader type.");
...
shooz.threejs.Loader.prototype.loaded = function(type, name)
{
	if(!(type in this.types))
	{
		console.warn("Unkown loader type.");
...
shooz.threejs.Loader.prototype.loadTexture = function(name, url)
{
	var self = this;
...
shooz.threejs.Loader.prototype.loadTextureCube = function(name, url)
{
	var self = this;
...
shooz.threejs.Loader.prototype.loadGeometry = function(name, url)
{
	var self = this;
...
shooz.threejs.Loader.prototype.loadAnalyser = function(name, url)
{
	var self = this;
	this.updateState("analysers", name, false);
	this.data.analysers[name] = new shooz.ImageData(
		url, 
		function(){ 
...
shooz.threejs.Loader.prototype.loadImage = function(name, url)
{
	var self = this;
...
shooz.threejs.Loader.prototype.loadSound = function(src, name, loop){
    var self = this;
    this.updateState("sounds", name, false);
    
    shooz.Audio.addSound(
    	src,
    	name, 
    	loop, 
    	function(){
    ...
    this.data.sounds[name] = {
        play: function(){
            shooz.Audio.play(name);
        },
        stop: function(){
            shooz.Audio.stop(name);
        },
        volume: function(vol){
            shooz.Audio.volume(name, vol);
        }
    };
};