 ...
 */
shooz.threejs.Particles = function(opts)
{
...
shooz.threejs.Particles.prototype.build = function()
{
	...
	{
		var p = new shooz.threejs.Particle();
		this.pool.push(p);
		this.buffer.push(p);
 ...
 * @param  int count
 */
shooz.threejs.Particles.prototype.emit = function(count)
{
...
shooz.threejs.Particles.prototype.randomVector = function()
{
 ...
 */
shooz.threejs.Particles.prototype.update = function(dt)
{
	var p, l;
...
shooz.threejs.Particle = function()
{
...
shooz.threejs.Particle.prototype.reset = function()
{
