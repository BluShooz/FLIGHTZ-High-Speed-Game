/*!
 * shooz.threejs.RenderManager helps handling multiple scenes, cameras and render loops.
 * 
 * @author Thibaut 'SHOOZ' Despoulain <http://shooz.com>
 * @license MIT
 * 
 * Initialize the a RenderManager by passing a Renderer object:
 * 		var renderManager = new shooz.threejs.RenderManager(new THREE.WebGLRenderer());
 * 
...
shooz.threejs.RenderManager = function(renderer)
{
...
shooz.threejs.RenderManager.prototype.add = function(id, scene, camera, render, objects)
{
...
shooz.threejs.RenderManager.prototype.get = function(id)
{
	return this.renders[id];
};

shooz.threejs.RenderManager.prototype.remove = function(id)
{
...
shooz.threejs.RenderManager.prototype.renderCurrent = function()
{
...
shooz.threejs.RenderManager.prototype.setCurrent = function(id)
{
	if(id in this.renders)
	{
