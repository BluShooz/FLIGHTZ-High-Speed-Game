...
shooz.flightz.RaceData = function(track, mode, shipControls)
{
	this.track = track;
	this.mode = mode;
...
shooz.flightz.RaceData.prototype.tick = function(time)
{
	if(this.rateState == 1)
	{
...
shooz.flightz.RaceData.prototype.applyInterpolated = function(time)
{
...
shooz.flightz.RaceData.prototype.reset = function()
{
	this.seek = 0;
}

shooz.flightz.RaceData.prototype.export = function()
{
	return this.data;
}

shooz.flightz.RaceData.prototype.import = function(imp)
{
	this.data = imp;
