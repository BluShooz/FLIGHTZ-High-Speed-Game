...
shooz.flightz.HUD = function(opts)
{
	var self = this;
...
shooz.flightz.HUD.prototype.resize = function(w, h)
{
	this.width = w;
	this.height = h;
	this.canvas.width = w;
...
shooz.flightz.HUD.prototype.display = function(msg, duration)
{
	this.messageTiming = 0;
...
shooz.flightz.HUD.prototype.updateLap = function(current, total)
{
	this.lap = current + this.lapSeparator + total;
}

shooz.flightz.HUD.prototype.resetLap = function()
{
	this.lap = "";
}

shooz.flightz.HUD.prototype.updateTime = function(time)
{
	this.time = this.timeSeparators[0] + time.m + this.timeSeparators[1] + time.s + this.timeSeparators[2] + time.ms + this.timeSeparators[3];
}

shooz.flightz.HUD.prototype.resetTime = function()
{
	this.time = "";
}

shooz.flightz.HUD.prototype.update = function(speed, speedRatio, shield, shieldRatio)
{
