...
shooz.flightz.tracks = shooz.flightz.tracks || {};

shooz.flightz.tracks.Cityscape = {
	...
	{
		this.lib = new shooz.threejs.Loader(opts);
	...
	buildMaterials: function(quality)
	{
		...
		{
			this.materials.track = shooz.Utils.createNormalMaterial({
			...
			this.materials.bonusBase = shooz.Utils.createNormalMaterial({
			...
			this.materials.ship = shooz.Utils.createNormalMaterial({
			...
			this.materials.scrapers1 = shooz.Utils.createNormalMaterial({
			...
			this.materials.scrapers2 = shooz.Utils.createNormalMaterial({
			...
			this.materials.start = shooz.Utils.createNormalMaterial({
	...
	buildScenes: function(ctx, quality)
	{
		...
		// SHIP CONTROLS
		var shipControls = new shooz.flightz.ShipControls(ctx);
		...
		ctx.components.shipEffects = new shooz.flightz.ShipEffects(fxParams);
		...
		// CAMERA
		ctx.components.cameraChase = new shooz.flightz.CameraChase({
			target: ship,
			camera: camera,
