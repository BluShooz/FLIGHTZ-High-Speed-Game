...
shooz.flightz.ShipControls = function(ctx)
{
	var self = this;
	...
	if(ctx.controlType == 1 && shooz.controllers.TouchController.isCompatible())
	{
		this.touchController = new shooz.controllers.TouchController(
	...
	else if(ctx.controlType == 4 && shooz.controllers.OrientationController.isCompatible())
	{
		this.orientationController = new shooz.controllers.OrientationController(
			domElement, true,
			function(state, touch, event){
				if(event.touches.length >= 4)
					window.location.reload(false);
	...
	else if(ctx.controlType == 3 && shooz.controllers.GamepadController.isCompatible())
	{
		this.gamepadController = new shooz.controllers.GamepadController(
      function(controller){
...
shooz.flightz.ShipControls.prototype.control = function(threeMesh)
{
	this.mesh = threeMesh;
...
shooz.flightz.ShipControls.prototype.reset = function(position, rotation)
{
...
shooz.flightz.ShipControls.prototype.terminate = function()
{
	this.destroy();
...
shooz.flightz.ShipControls.prototype.destroy = function()
{
	shooz.Audio.play('destroyed');
	shooz.Audio.stop('bg');
...
shooz.flightz.ShipControls.prototype.fall = function()
{
	this.active = false;
	this.collision.front = false;
	this.collision.left = false;
...
shooz.flightz.ShipControls.prototype.update = function(dt)
{
	if(this.falling)
	{
	...
	shooz.Audio.setListenerPos(this.movement);
	shooz.Audio.setListenerVelocity(this.currentVelocity);
};

shooz.flightz.ShipControls.prototype.teleport = function(pos, quat)
{
...
shooz.flightz.ShipControls.prototype.boosterCheck = function(dt)
{
...
shooz.flightz.ShipControls.prototype.collisionCheck = function(dt)
{
...
shooz.flightz.ShipControls.prototype.heightCheck = function(dt)
{
...
shooz.flightz.ShipControls.prototype.getRealSpeed = function(scale)
{
	return Math.round(
...
shooz.flightz.ShipControls.prototype.getRealSpeedRatio = function()
{
	return Math.min(
		this.maxSpeed,
		this.speed+this.boost
...
shooz.flightz.ShipControls.prototype.getSpeedRatio = function()
{
	return (this.speed+this.boost)/ this.maxSpeed;
};

shooz.flightz.ShipControls.prototype.getBoostRatio = function()
{
	return this.boost / this.boosterSpeed;
};

shooz.flightz.ShipControls.prototype.getShieldRatio = function()
{
	return this.shield / this.maxShield;
};

shooz.flightz.ShipControls.prototype.getShield = function(scale)
{
	return Math.round(
		this.shield
		* (scale == undefined ? 1 : scale)
...
shooz.flightz.ShipControls.prototype.getPosition = function()
{
	return this.dummy.position;
}

shooz.flightz.ShipControls.prototype.getQuaternion = function()
{
