...
shooz.flightz.ShipEffects = function(opts)
{
	...
	if(this.useParticles)
	{
		...
		this.particles = {
			...
			leftSparks: new shooz.threejs.Particles(
			{
			...
			leftClouds: new shooz.threejs.Particles(
			{
				opacity: 0.8,
				tint: 0xffffff,
				color: 0x666666,
			...
			rightSparks: new shooz.threejs.Particles(
			{
				randomness: new THREE.Vector3(0.4,0.4,0.4),
				tint: 0xffffff,
				color: 0xffc000,
			...
			rightClouds: new shooz.threejs.Particles(
			{
				opacity: 0.8,
				tint: 0xffffff,
				color: 0x666666,
...
shooz.flightz.ShipEffects.prototype.update = function(dt)
{
