...
shooz.flightz.Gameplay = function(opts)
{
	var self = this;
...
shooz.flightz.Gameplay.prototype.simu = function()
{
...
shooz.flightz.Gameplay.prototype.start = function(opts)
{
	this.finishTime = null;
	this.score = null;
	this.lap = 1;
	...
	this.raceData = new shooz.flightz.RaceData(this.track.name, this.mode, this.shipControls);
	if(this.mode == 'replay')
	{
...
shooz.flightz.Gameplay.prototype.end = function(result)
{
...
shooz.flightz.Gameplay.prototype.update = function()
{
...
shooz.flightz.Gameplay.prototype.checkPoint = function()
{
